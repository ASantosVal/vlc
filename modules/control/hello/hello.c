...
{
    intf_thread_t *intf = (intf_thread_t *)obj; //interface specific
    ...
    /* UPnP */
    vlc_renderer_discovery_t * prueba =(vlc_renderer_discovery_t *)obj;    
    int i;
    i = vlc_rd_start(prueba);

    /* Dialog API */    
    while (vlc_dialog_wait_question(obj,
